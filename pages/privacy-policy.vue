<template>
    <UiCenter>
        ...
        <UiParagraph>
            ...
            Please be aware that we may revise our Privacy Policy in the future.<br>
            Updated versions will be uploaded onto our website (www.ta1-shop.com), so please check back from time to time.
        </UiParagraph>
    </UiCenter>
</template>
