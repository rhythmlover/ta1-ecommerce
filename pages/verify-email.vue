        ...
        <div class="mt-7 bg-white rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700 border-2 border-indigo-300">
            <div class="p-4 sm:p-7">
                <div class="text-center">
                    <p v-if="validationSuccess" class="block text-2xl font-bold text-green-600 dark:text-white">{{ validationMessage }}</p>
                    <p v-else v-html="errorMessage" class="block text-2xl font-bold text-red-600 dark:text-white" />
                </div>
            </div>
        </div>
    </main>
